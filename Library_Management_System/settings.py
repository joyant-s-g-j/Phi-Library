...
ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://phi-library.onrender.com','https://*.127.0.0.1']
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        default='postgresql://philibrary_user:mEpHPsMn61qDQ0qXKNaQq54Kzh8KridG@dpg-csjvjv0gph6c73a5tns0-a.oregon-postgres.render.com/philibrary',
    )
}
...
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # Correct path for additional static files
]
